...
class Actor(nn.Module):
    """ Actor for discrete action spaces (atari) """
...
class ActorCriticTrainer:
    ...
    def __init__(self, policy, actor_optimizer, critic_optimizer, reward_act, return_norm,
        ...
        self.actor_optim = nets.Optimizer(policy.actor, **actor_optimizer, total_its=total_its, autocast=autocast)
        self.critic_optim = nets.Optimizer(policy.critic, **critic_optimizer, total_its=total_its, autocast=autocast)
    ...
    def _optimize(self, x, a, target_v, ret, adv, seq_mask, it):
        ...
        self.actor_optim.step(actor_loss, batch_size, it)
        ...
        self.critic_optim.step(critic_loss, batch_size, it)
        return metrics
    ...
    def train(self, it, xs, final_x, as_, next_rs, next_terms):
        ...
        with self.autocast(), torch.no_grad():
                ...
                rets = utils.lamdba_return(self.reward_act(next_rs), next_vs, next_gammas, self.lmbda)
